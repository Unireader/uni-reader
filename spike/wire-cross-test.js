...
const canonical = [
  ...
  { type: "docs", list: [{ id: "a", title: "T1", ws: "W1" }, { id: "b", title: "标题", ws: "内覆盖" }], selected: "a", following: false },
  ...
  // display=0 的老形态由上面既有的两条覆盖；这里专测另外两个值不被「缺省即 0」吃掉。
