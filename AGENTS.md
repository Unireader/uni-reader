...
- `MCP-PLAN.md` — MCP 服务（给外部 Agent 用，App 内置 HTTP 端点，默认回环、可绑所有接口+口令）：分批工具目录、协议层、线程红线、写入策略（2026-09-13 拍板；**批 1 已落地在分支 `worktree-mcp`，§15 是实现记录**，待用户实测）
