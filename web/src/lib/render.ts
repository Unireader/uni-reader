...
// 四种笔型的几何算法住在 `inkGeom.ts`（纯函数，三端绘制对比工具直接 import 它出图）。
import { buildGeomWith, paintGeomAt } from "./inkGeom.js";
import type { InkGeom } from "./inkGeom.js";
...
export function initRender(refs: CaptureRefs): void {
  ...
  const BUB = { w: 0.30, fs: 0.017, lh: 1.25, pad: 0.30, radius: 0.4, gap: 0.25, edit: 1.7,
