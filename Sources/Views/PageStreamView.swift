...
private struct InkStaticLayer: View, Equatable {
    let strokes: [InkStroke]
...
private struct InkLiveLayer: View, Equatable {
    let live: InkStroke
    let inkScale: CGFloat
...
private func inkDrawStroke(_ st: InkStroke, in ctx: inout GraphicsContext, size: CGSize, inkScale: CGFloat) {
