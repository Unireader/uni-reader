...
| 4 | 四种笔各写几笔，与 Mac 并排比 | 形状/粗细/颜色/压感一致（**marker 现在偏暗发浊，是 §9.4，已知**） | `落笔 page=… 点数=… layer=…` |
| 5 | 开尺子写一笔 | 直线 + 45° 吸附是**看上去**的角度 | 落笔 `点数=2` |
| 6 | 局部擦除横穿一条笔迹 | 切成两段，回 Mac 打开与平板所见一致 | `擦除落库：删 N 条，插 M 段` |
...
**不能**：笔迹观感（§9.4 那类混合模式问题肉眼才看得出）、手感（吸附/惯性/拖动回弹）、
